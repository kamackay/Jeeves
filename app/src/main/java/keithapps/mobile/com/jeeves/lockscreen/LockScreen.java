package keithapps.mobile.com.jeeves.lockscreen;
...
public class LockScreen extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT)
            flags |= View.SYSTEM_UI_FLAG_IMMERSIVE_STICKY | View.SYSTEM_UI_FLAG_IMMERSIVE;
    ...
    public boolean onKeyDown(int keycode, KeyEvent e) {
        switch (keycode) {
            ...
            case KeyEvent.KEYCODE_HOME:
                KeithToast.show("Home", getApplicationContext());
                return true;
        }
    ...
    public void showJeeves(View view) {
