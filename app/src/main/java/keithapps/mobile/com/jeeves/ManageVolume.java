...
public class ManageVolume {
    ...
    public static void setSystemVolume(Context c, AudioManager a, SharedPreferences prefs, Mode mode) {
        if (mode == Mode.Class)
    ...
    public static void setSystemVolume(Context c, Mode mode) {
        if (mode == Mode.Class)
    ...
    public static void setNotificationVolume(Context c, AudioManager a, SharedPreferences prefs, Mode mode) {
        if (mode == Mode.Class)
    ...
    public static void setNotificationVolume(Context c, Mode mode) {
        if (mode == Mode.Class)
    ...
    public static void setAlarmVolume(Context c, AudioManager a, SharedPreferences prefs, Mode mode) {
        if (mode == Mode.Class)
    ...
    public static void setAlarmVolume(Context c, Mode mode) {
        if (mode == Mode.Class)
    ...
    public static void setMediaVolume(Context c, AudioManager a, SharedPreferences prefs, Mode mode) {
        if (mode == Mode.Class)
    ...
    public static void setMediaVolume(Context c, Mode mode) {
        if (mode == Mode.Class)
    ...
    public static void setRingtoneVolume(Context c, AudioManager a, SharedPreferences prefs, Mode mode) {
        if (mode == Mode.Class)
    ...
    public static void setRingtoneVolume(Context c, Mode mode) {
        if (mode == Mode.Class)
    ...
    public enum Mode {Class, Car, Out, Home}
}
